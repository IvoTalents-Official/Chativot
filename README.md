...
Todos los subdominios apuntan a `IP-SERVIDOR-DEV` con proxy Cloudflare **activado** 🟠 (nube naranja).

| Subdominio | IP |
|---|---|
| chatdev.chativot.com | IP-SERVIDOR-DEV |
| n8ndev.chativot.com | IP-SERVIDOR-DEV |
| fzapdev.chativot.com | IP-SERVIDOR-DEV |
| zabbixdev.chativot.com | IP-SERVIDOR-DEV |
| bddev.chativot.com | IP-SERVIDOR-DEV |
| redisdev.chativot.com | IP-SERVIDOR-DEV |
| dev.chativot.com | IP-SERVIDOR-DEV |
